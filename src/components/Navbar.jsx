    ...
    <>
      ...
      >
        <div className="navtop py-12 px-6 lg:px-9 h-[123px] flex justify-between items-center mb-16 md:mb-40 lg:mb-2">
          ...
          <div className="close_tag pt-32 ml-2 md:ml-2 lg:ml-9 flex cursor-pointer items-center justify-center lg:pt-0 lg:mt-0  w-full h-[90px]">
        ...
        <div className="links mt-20 lg:mt-0 uppercase">
